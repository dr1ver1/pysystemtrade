...
barchart_csv_config = ConfigCsvFuturesPrices(input_date_index_name="tradeTime",
    input_skiprows=0,
    input_skipfooter=0,
    input_date_format="%d/%m/%Y", # Will backslahes work ok?
    input_column_mapping=dict(OPEN="OPEN", HIGH="HIGH", LOW="LOW", FINAL="PRICE", VOLUME="VOLUME"
    ),
)
